        ...
        <Modal title='File Detail' open={open} onClose={onClose}>
            <div className={styles.fileDetailDiv}>
                <div className={styles.filePreview}>
                    {fileHistoryName &&
                        fileHistoryName.map((name, index) => {
                            return (
                                <ListItem button style={{ borderBottom: '2px dotted grey' }}>
                                    <Checkbox
                                        color='default'
            ...
            <div style={{ textAlign: 'center', margin: 10 }}>
                <a href={`/api/store/download-drive-file?fileId=${selectedFilePk}`}>
                    <Button variant='contained' color='primary' fontSize='small' className={classes.button}>
                        Download
                    </Button>
                </a>
                <Button
                    ...
                    <div className={classes.historyModalDiv}>
                        ...
                        {file.map((uploaded) => (
                            <div key={uploaded.name}>
                                <Typography variant='caption' gutterBottom className={classes.fileName}>
                                    {uploaded.name}
                                </Typography>
