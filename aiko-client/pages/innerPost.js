        ...
        <>
            <div className={styles.outerContainer}>
                <div className={styles.titleName}>
                    ...
                    <p style={{ fontSize: '17px', color: '#6F6A6A' }}>
                        Posted by {name}, {date}
                    </p>
                </div>

                <div className={styles.contentArea}>
                    <textarea className={styles.contentInput} value={ReactHtmlParser(content)} onChange={handleContent} />
                </div>
                ...
                <div className={styles.anotherPost} style={{ marginTop: '15px' }}>
                    <div className={styles.previousPost}>
                        ...
                        >
                            사내식당 공지) 2021년 11월 건강한 식생활을 위한 채식주의 방침
                        </p>
                    </div>
